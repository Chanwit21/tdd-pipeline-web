...
import { PageHead, Field, Subtabs, SkeletonRows } from "@/components/ui";
    ...
    <div className="panel">
      ...
      >
        ...
        <div className="filter-buttons">
          ...
          <button type="button" className="btn btn-sm" disabled={loading || !data} onClick={exportReport}><IcoDownload size={14} /> Export</button>
      ...
      <div className="table-wrap" style={{ padding: "0 18px 18px" }}><table className="pivot">
        ...
        <tbody>
          {loading ? <SkeletonRows cols={(data?.columns.length ?? 3) + 3} rows={5} /> : <>
